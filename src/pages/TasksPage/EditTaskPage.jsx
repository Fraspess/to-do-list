...
import { editTask } from "../../store/reducers/tasksReducer/tasksReducer"
...
const EditTaskPage = () => {
    ...
    const editTTask = tasks.find((task) => task.id == id);
    ...
    const parseOriginalDate = (originalDateString) => {
        if (!originalDateString) return "";

        const datePart = originalDateString.split(' at ')[0];
    ...
    const initValues = {
        name: editTTask.name,
        deadline:parseOriginalDate(editTTask.deadline),
        description: editTTask.description,
        priority: editTTask.priority,
        tags: editTTask.tags
    }
